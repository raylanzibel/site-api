...
type
  TZibelWebModule = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TZibelWebModule;
...
procedure TZibelWebModule.WebModuleCreate(Sender: TObject);
begin
  ...
  FMVC.AddController(TZibelController);
...
procedure TZibelWebModule.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
